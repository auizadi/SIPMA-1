    ...
    <div class="row">
        <div class="col">
            <div class="notification">
                Konfirmasi email <span class="font-weight-bold">{{ Auth::guard('mahasiswa')->user()->email }}</span> untuk melindungi akun Anda.
...
<div class="container">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #6a70fc" href="#">{{ Auth::guard('mahasiswa')->user()->nama }}</a></h5>
                        <p class="text-dark">{{ Auth::guard('mahasiswa')->user()->username }}</p>
                    </div>
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : ''}} mr-4" href="{{ route('sipma.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('sipma.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
